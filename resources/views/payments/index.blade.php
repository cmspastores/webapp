    ...
    <div class="container">
        <div class="card table-card">
            <table class="simple-table">
                <thead>
                    <a href="{{ route('payments.create') }}" class="btn-new">+ New Payment</a>
                    <tr><th>ID</th><th>Payer</th><th>Amount</th><th>Applied</th><th>Unallocated</th><th>Date</th><th>Actions</th></tr>
                </thead>
                <tbody>
                    @foreach($payments as $p)
                        <tr>
                            ...
                            <td>{{ $p->payment_date?->toDateTimeString() }}</td>
                            <td>
                                <a href="{{ route('payments.show', $p) }}" class="btn-yellow">View</a>
                                <form method="POST" action="{{ route('payments.destroy', $p) }}" onsubmit="return confirm('Delete payment?');" style="display:inline">
                                    @csrf
                                    @method('DELETE')
