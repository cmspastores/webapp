...
<!-- Sidebar Styles -->
<style>
.sidebar{background:linear-gradient(180deg,#FFF5EC,#F7E1B5);border-right:2px solid #E6A574;min-height:100vh;display:flex;flex-direction:column;justify-content:space-between;width:16rem;color:#5C3A21;box-sizing:border-box;transition:width .3s ease;position:relative;}
...
.sidebar-toggle{position:absolute;top:1rem;right:-2rem;background:#D98348;color:#FFF;border:none;border-radius:6px;padding:.5rem;cursor:pointer;box-shadow:0 2px 6px rgba(0,0,0,0.2);transition:.2s;}
...
.sidebar.collapsed .sidebar-top h2,
.sidebar.collapsed .sidebar-label,
.sidebar.collapsed ul li a{display:none;}
.sidebar.collapsed .sidebar-top,
.sidebar.collapsed .sidebar-bottom{padding:0 .25rem;}
</style>
